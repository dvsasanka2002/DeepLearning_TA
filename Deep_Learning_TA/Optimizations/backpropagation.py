...
train_dataset_path = '/content/DeepLearning_TA/Deep_Learning_TA/Backpropagation/datasets/train_catvnoncat.h5'
test_dataset_path = '/content/DeepLearning_TA/Deep_Learning_TA/Backpropagation/datasets/test_catvnoncat.h5'
...
def init_weights_deep(layer_dims):
    """
    Arguments:
...
def L_layer_model(X, Y, layers_dims, learning_rate = 0.0075, num_iterations = 3000, print_cost=False):
    ...
    parameters = init_weights_deep(layers_dims)
